        ...
        actions={
          <div className="flex gap-2">
            <button
              ...
              className="inline-flex items-center gap-2 rounded-xl border border-[#C6D4BF] bg-white px-3 py-2 text-sm font-semibold text-[#7A9076] hover:bg-[#E6ECE2] transition-colors"
            >
              <DownloadIcon /> Export
            </button>
            <button
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="bg-[#E6ECE2] text-left">
                      <th className="px-4 py-3 font-semibold text-[#333333] whitespace-nowrap">
                        Date &amp; Time
                      </th>
                      ...
                      <th className="px-4 py-3 font-semibold text-[#333333] hidden xl:table-cell text-right">
                        Discount
                      </th>
                  ...
                  <tbody>
                    {sales.map((sale, i) => (
                      <tr
                        ...
                        className={`cursor-pointer hover:bg-[#E6ECE2]/30 transition-colors ${
                          i % 2 === 0 ? "bg-white" : "bg-[#E6ECE2]/10"
                        }`}
                      >
      ...
      <div className="flex flex-col gap-5">
                  ...
                  <thead>
                    <tr className="bg-[#E6ECE2] text-left">
                      {[
                        ...
                        <th
                          key={h}
                          className="px-3 py-2.5 font-semibold text-[#333333] whitespace-nowrap"
                        >
                          {h}
                        </th>
                      ))}
                  ...
                  <tbody>
                    {view.items.map((item, i) => (
                      ...
                      >
                        ...
                        <td className="px-3 py-2.5 font-mono text-xs text-[#666666]">
                          {item.batch}
                        </td>
                        <td className="px-3 py-2.5 text-[#666666]">
                          {item.unit}
                        </td>
                        <td className="px-3 py-2.5 text-center font-semibold text-[#333333]">
                          {item.qty}
                        </td>
                        <td className="px-3 py-2.5 text-right text-[#333333]">
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          ...
          <div className="bg-[#E6ECE2]/40 rounded-xl p-4 flex flex-col gap-2">
            ...
            <SummaryRow
              label="Subtotal"
              value={`${view.subtotal.toLocaleString(undefined, { minimumFractionDigits: 2 })} ETB`}
            />
            {view.discount > 0 && (
              <SummaryRow
                label="Bill Discount"
            ...
            <div className="border-t border-[#C6D4BF] pt-2 mt-1">
              <SummaryRow
                label="Total"
                value={`${view.total.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })} ETB`}
                bold
              />
            </div>
            <div className="border-t border-[#C6D4BF] pt-2 mt-1">
              <SummaryRow
                label="Paid"
                value={`${view.paidAmount.toLocaleString(undefined, { minimumFractionDigits: 2 })} ETB`}
              />
              {view.changeAmount > 0 && (
                <SummaryRow
                  label="Change"
...
function SummaryCard({
  ...
  return (
    <div className="bg-white rounded-xl border border-[#E6ECE2] p-4">
      ...
      <p className={`text-xl font-bold mt-1 ${accent ?? "text-[#333333]"}`}>
        {value}
      </p>
    </div>
  )
...
function PaymentBadge({ method }: { method: PaymentMethod }) {
  const cfg: Record<PaymentMethod, StatusTone> = {
    Cash: "green",
    Card: "blue",
    "Digital Transfer": "purple",
    Insurance: "sage",
  }
