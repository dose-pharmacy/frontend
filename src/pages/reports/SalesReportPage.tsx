                ...
                <table className="w-full text-sm">
                  ...
                  <tbody>
                    {sales.map((sale, i) => (
                      <tr
                        key={sale.id}
                        className={`hover:bg-[#E6ECE2]/30 transition-colors cursor-pointer ${
                          i % 2 === 0 ? "bg-white" : "bg-[#E6ECE2]/15"
                        }`}
                        onClick={() => openDetail(sale)}
                      >
                        <td className="px-4 py-3 font-semibold text-[#7A9076] whitespace-nowrap">
                          {sale.saleNumber}
                        </td>
                        ...
                        <td className="px-4 py-3 text-right text-[#666666]">
                          {sale.items ? fmtNumber(sale.items.length) : "—"}
                        </td>
                        <td className="px-4 py-3 text-right text-[#666666]">
                          {fmtMoney(sale.totalDiscount)}
                        </td>
          ...
          <div className="flex flex-col gap-5">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              {[
                ...
                <div
                  key={label}
                  className="rounded-xl bg-[#E6ECE2]/40 border border-[#E6ECE2] px-4 py-3"
                >
              ...
              {detailLines.length === 0 ? (
                ...
                <div className="rounded-xl border border-[#E6ECE2] overflow-hidden">
                  <table className="w-full text-sm">
                    <thead>
                      <tr className="bg-[#E6ECE2] text-left">
                        <th className="px-4 py-2.5 font-semibold text-[#333333]">
                          Product
                        </th>
                        <th className="px-4 py-2.5 font-semibold text-[#333333]">
                          SKU
