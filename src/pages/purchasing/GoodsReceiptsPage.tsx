      ...
      <div className="flex-1 overflow-y-auto p-6 flex flex-col gap-5">
        ...
        <div className="bg-white rounded-xl border border-[#DBEFF3] p-4 flex flex-col gap-3">
          ...
          <div className="flex flex-wrap gap-3 items-center">
            <select value={statusFilter} onChange={(e) => { setStatusFilter(e.target.value as GoodsReceiptStatus | ""); setPage(1) }} className="flex-1 min-w-[160px] rounded-xl border border-[#ABDBE3] px-3.5 py-2.5 text-sm focus:border-[#49B0C1] focus:outline-none">
        ...
        <div className="bg-white rounded-xl border border-[#DBEFF3] overflow-hidden">
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center py-20 gap-4">
              ...
              {(search || statusFilter) ? (
                <button onClick={() => { setSearch(""); setStatusFilter(""); setPage(1) }} className="text-sm font-semibold text-[#49B0C1] hover:underline">Clear Filters</button>
              ) : (
