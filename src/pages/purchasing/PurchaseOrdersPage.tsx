...
const STATUS_CFG: Record<POStatus, { label: string tone: StatusTone }> = {
  REGISTERED: { label: "Registered", tone: "blue" },
  AWAITING_DELIVERY: { label: "Awaiting Delivery", tone: "amber" },
  RECEIVED: { label: "Received", tone: "sage" },
...
export default function PurchaseOrdersPage() {
  ...
  async function runStatusAction() {
    ...
    setActionError("")
    try {
      if (action === "markDelivery")
        await markPurchaseOrderAwaitingDelivery(po.id)
  ...
  const confirmCfg = actionTarget
    ? {
        markDelivery: {
          ...
          message: `Send ${actionTarget.po.reference} to the supplier and mark it as awaiting delivery?`,
        ...
        close: {
          ...
          confirmClass: "bg-[#B6C8AF] hover:bg-[#7A9076] text-[#333333]",
          cancelLabel: "Cancel",
        },
        cancel: {
          title: "Cancel Purchase Order?",
          message: `Are you sure you want to cancel ${actionTarget.po.reference}? This action will mark the order as cancelled.`,
