        ...
        actions={
          !showForm && (
            <button
              ...
              className="rounded-lg border border-[#C6D4BF] bg-white px-4 py-2 text-sm font-semibold text-[#7A9076] hover:bg-[#E6ECE2] transition-colors"
            >
              + New Return
            </button>
          )
            ...
            <div className="bg-white rounded-xl border border-[#E6ECE2] p-5">
                  ...
                  >
                    ...
                    {batches.map((b) => (
                      <option key={b.id} value={b.id}>
                        {b.batchNumber} · Exp: {fmtDate(b.expiryDate)} · Stock:{" "}
                        {b.totalQuantity}
                      </option>
                    ))}
                  </select>
                  {batches.length === 0 && productId && !batchesLoading && (
                    <p className="mt-1 text-xs text-[#666666]">
                      ...
                      <Link
                        ...
                        className="text-[#7A9076] hover:underline"
                      >
                ...
                <div>
                  <label className="block text-sm text-[#666666] mb-1">
                    ...
                    <span className="text-xs font-normal">
                      (defaults to the batch cost when left empty)
                    </span>
                  </label>
                  <input
                    type="number"
              ...
              {productId && quantity > 0 && parsedUnitCost > 0 && (
                <div className="mt-4 p-3 rounded-lg bg-[#E6ECE2] text-sm text-[#333333]">
                  ...
                  {selectedProduct?.name ?? "?"} — Total Value:{" "}
              ...
              <div className="flex items-center gap-3 mt-4 pt-4 border-t border-[#E6ECE2]">
                ...
                <button
                  ...
                  title={
                    !canSubmit
                      ? "Select a supplier and product, and enter a quantity and unit cost greater than zero."
                      : undefined
                  }
                ...
                {batchQuantityUsed && !saving && canSubmit && (
                  <span className="text-xs text-[#666666]">
                    Unit cost will be taken from the selected batch.
                  </span>
                )}
              </div>
            </div>
                      ...
                      >
                        ...
                        <td className="px-4 py-3">
                          <StatusChip
                            ...
                            tone={REASON_BADGE[ret.reason] ?? "gray"}
                          />
                        </td>
